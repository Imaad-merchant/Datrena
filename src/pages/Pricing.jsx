...
const PLANS = [
  {
    ...
    features: [
      { label: "Candlestick Chart (delayed)", included: true },
      { label: "1 Instrument", included: true },
      { label: "5m Timeframe Only", included: true },
      { label: "Footprint Chart", included: false },
      { label: "Delta / Volume Analysis", included: false },
      { label: "AI Quant Chat", included: false },
      { label: "Multiple Timeframes", included: false },
